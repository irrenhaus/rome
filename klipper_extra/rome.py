...
class ROME:
    ...
    def cmd_ROME_START_PRINT(self, param):
        ...
        x0 = param.get_float('X0', None)
        y0 = param.get_float('Y0', None)
        x1 = param.get_float('X1', None)
        y1 = param.get_float('Y1', None)

        adaptive_bed_params = ""
        if x0 != None and y0 != None and x1 != None and y1 != None:
            adaptive_bed_params = f" X0={x0} Y0={y0} X1={x1} Y1={y1}"
        ...
        self.gcode.run_script_from_command("START_PRINT BED_TEMP=" + str(bed_temp) + " EXTRUDER_TEMP=" + str(extruder_temp) + " CHAMBER_TEMP=" + str(chamber_temp) + str(adaptive_bed_params))
